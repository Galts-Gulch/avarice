  ...
  def __init__(self):
    ...
    self.indicatoroptions = {'Verbose': {'Type': 'checkbox', 'Description': 'Should we print additional information about the indicator on each candle?'},
                             ...
                             {'Description': 'Used for aggregation. E.g. set to 3 if on 5 min candles and 15min indicator period is desired.',
                              'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Indicator Strategy': {'Description': 'Convergence/Divergence trades on short/long convergence/divergence. Difference trades on the difference between short/long.',
                                                    ...
                                                    'Type': 'ComboBox'},
                             'Tenkan-Sen Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Senkou Span Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1),
                                                    'Description': 'Default is 2 * Kijun-Sen Period'},
                             'Kijun-Sen Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Chikou Span Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1),
                                                    'Description': 'Default is the same as Kijun-Sen Period'},
                             'Trade Volume': {'Type': 'SpinButton', 'SpinButtonFloat': True, 'SpinButtonRange': (1, 99, 1),
                             ...
                             'Trade Delay': {'Type': 'SpinButton', 'SpinButtonRange': (1, 100, 1),
                                             'Description': 'Number of candles with indicator info before trading.'},
                             'Short Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Long Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Alpha Constant': {'Type': 'SpinButton', 'SpinButtonFloat': True, 'SpinButtonRange': (-10, 10, 0.1)},
                             'Signal Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Fast K Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Full K Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Full D Period': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             'Multiplier': {'Type': 'SpinButton', 'SpinButtonRange': (1, 1000, 1)},
                             ...
                             'Bid': {'Type': 'SpinButton', 'Description': 'Buy when less than Bid', 'SpinButtonRange': (-100, 100, 1)},
                             'Ask': {'Type': 'SpinButton', 'Description': 'Sell when greater than Ask', 'SpinButtonRange': (-100, 100, 1)},
                             'Diff Up': {'Type': 'SpinButton', 'SpinButtonFloat': True, 'SpinButtonRange': (-1, 1, 0.001),
                                         'Description': 'Wait to pass this threshold before trend is determined.'},
                             'Diff Down': {'Type': 'SpinButton', 'SpinButtonFloat': True, 'SpinButtonRange': (-1, 1, 0.001),
                                           'Description': 'Wait to pass this threshold before trend is determined.'},
                             'Threshold': {'Type': 'SpinButton', 'SpinButtonFloat': True, 'SpinButtonRange': (0, 100, 0.1),
                                           'Description': 'Threshold to limit trades for volatility indicators.'}}
